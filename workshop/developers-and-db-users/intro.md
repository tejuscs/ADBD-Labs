...
## Introduction to Oracle Autonomous AI Database Dedicated for Developers and Database Users
...
## Workshop Objectives
This set of hands-on-labs is designed to assist developers and database users with setting up and using various features of the **Autonomous AI Database on Dedicated Exadata Infrastructure Service**. The labs in this workshop address provisioning, application development, monitoring, tuning of Autonomous AI Databases, as well as recovery from user errors.
...
Lab 15: API Gateway with Autonomous AI Database Dedicated  
Lab 16: Database In-Memory on Autonomous AI Database Dedicated  


### *Also see our third Autonomous AI Database Dedicated workshop, Introduction to Oracle Autonomous AI Database Dedicated for Database Security Administrators*
