...
In this lab we will configure and deploy a java application in a developer client VM and connect it to an Autonomous AI Database.
...
- Learn how to deploy a java application and connect it to your dedicated Autonomous AI Database instance.
...
- Log in to Oracle Cloud Infrastructure account and click **Autonomous AI Transaction Processing** from top left menu.
...
- Database connections to your Autonomous AI Database use a secure connection. You will be asked to create a password for your wallet.
...
- Change **dbinstance**, **dbcredpath**, **dbuser**, **dbpassword** as per the Autonomous AI Database you created earlier.
...
*Congratulations! You successfully deployed and connected a java app to your Autonomous AI Database.*
